...
UAE is home to over a million African expats (Kenya, Nigeria, Uganda, Egypt, and more), most of whom send money home regularly. Traditional remittance rails (exchange houses, money transfer operators) typically charge 5-9% in fees and take 24-48 hours to settle, and reconciling "did my mother actually receive this" usually means a phone call and a reference number scribbled on a receipt.

## What RemitArc does

1. A UAE-based sender enters an amount in AED and picks a recipient corridor (Kenya/M-Pesa, Nigeria/MTN MoMo, Uganda/MTN MoMo, Egypt/Fawry).
...
(To be filled in as development progresses - required by the submission rubric.)

- Why we chose these products: Circle Wallets remove the single biggest UX barrier for a non-crypto-native remittance sender/recipient (seed phrases). Arc's Memo contract directly solves the reconciliation problem that's endemic to remittances - proving a transfer happened without relying on a centralized record.
- What worked well: TBD once testnet integration is live.
...
- StableFX for live AED/KES/NGN/UGX/EGP FX rates instead of static reference rates.
